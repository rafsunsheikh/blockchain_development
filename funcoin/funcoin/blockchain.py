...
class Blockchain(object):
    ...
    def new_block(self):
        ...
        # Rest the list of pending transactions
        self.pending_transactions = []
    ...
    def create_block(
        ...
        # Get the hash of this block, and add it to the block
    ...
    def valid_block(self, block):
        # Check in a block's hash is less than the target...
    ...
    def recalculate_target(self, block_index):
        ...
        if block_index % 10 == 0:
            ...
            # Now let's adjust the ratio to net be too extreme
            ...
            logger.info(f"Claculated new mining target: {self.target}")
